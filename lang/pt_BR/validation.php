...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'id_number' => 'número do BI',
        'birth_date' => 'data de nascimento',
        'marital_status' => 'estado civil',
        'education_level' => 'nível académico',
        'education_area' => 'área de formação',
        'provenance_id' => 'proveniência',
        'current_rank_id' => 'patente actual',
        'pna_entry_date' => 'data de ingresso na PNA',
        'father_name' => 'nome do pai',
        'mother_name' => 'nome da mãe',
        'recruitment_type_id' => 'tipo de recrutamento',
        'academic_year_id' => 'ano académico',
        ...
        'organ' => 'órgão',
        'max_students' => 'vagas/estudantes max',
        'order' => 'ordem',
        'workload_hours' => 'carga horária',
        'course_phase_id' => 'fase de curso',
        'has_phases' => 'possui fases',
